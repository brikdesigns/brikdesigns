...
import { Footer as BdsFooter } from '@bds/components/ui/Footer/Footer';
 ...
 *
 * Two known minor regressions vs the previous bespoke footer:
 *   1. Social column links lose target=_blank — BDS FooterColumnLink has no
 *      external field. Tracked: brik-bds#461.
 *   2. Internal links lose Next.js client-side navigation + prefetching — BDS
 *      Footer renders bare <a href> instead of next/link. Tracked: brik-bds#462.
 */
